...
//	private static final String DEBUG = "DEBUG";
    ...
    private void sharedConstructing(Context context) {
        ...
        ScaleGestureDetector mScaleDetector = new ScaleGestureDetector(context, new ScaleListener());
    ...
    public void setOnTouchListener(View.OnTouchListener l) {
        OnTouchListener userTouchListener = l;
    }
...
/*
 ...
 /*
    ...
    public void setZoom(TouchImageView img) {        //AAG
